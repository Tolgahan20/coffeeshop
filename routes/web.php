...
Route::get('/menu', [App\Http\Controllers\HomeController::class, 'menuPage'])->name('menu');
...
Route::get('/order', [App\Http\Controllers\HomeController::class, 'orderPage'])->name('order');
