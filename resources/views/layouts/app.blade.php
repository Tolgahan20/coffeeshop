...
<head>
    ...
    <link href="{{url('https://fonts.googleapis.com/css2?family=Montserrat+Alternates:ital,wght@0,400;0,500;0,600;0,700;0,900;1,400;1,500;1,600;1,700&display=swap')}}" rel="stylesheet">
<!-- CSS only -->
<link href="{{url('https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css')}}" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
    ...
    <div id="app" class="container-fluid d-flex flex-column min-vh-100" >
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Ninth navbar example">
            <div class="container-xl">
              <a class="navbar-brand" href="#"> <img src="{{asset('images/golifa.png')}}" height="90px" width="150px"></a>
        ...
        <main class="py-4">
            ...
            <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5  bg-dark mt-auto">
              ...
              <div class="col mb-3">
                <h5>Ödeme</h5>
                <ul class="nav flex-column">
                  <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Ödeme Yöntemleri</a></li>
...
<script src="{{url('https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js')}}" integrity="sha384-A3rJD856KowSb7dwlZdYEkO39Gagi7vIsF0jrRAoQmDKKtQBHUuLZ9AsSv4jD4Xa" crossorigin="anonymous"></script>
